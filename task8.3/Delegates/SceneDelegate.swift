...
//        let nagigation = UINavigationController(rootViewController: vc)
//        window.rootViewController = nagigation
//        self.window = window
...
//
    ...
    let tabOne = ViewController()
        ...
        let tabBarNC = UINavigationController(rootViewController: tabTwo)
        let tabTwoBarItem = UITabBarItem(title: "",
                                         image: UIImage(systemName: "bell"),
                                         selectedImage: UIImage(systemName: "bell"))
        tabBarNC.tabBarItem = tabTwoBarItem
        ...
        tabBarController.viewControllers = [tabOne, tabBarNC]
